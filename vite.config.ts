...
export default defineConfig({
  ...
  plugins: [
    VitePWA({
      // Офлайн-режим включён: service worker кэширует игру и обновляется сам.
      // Битый кэш у старых пользователей уже вычищен предыдущим
      // самоуничтожающимся SW, поэтому офлайн снова безопасно включать.
